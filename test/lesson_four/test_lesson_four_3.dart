...
void runTestLecture4hometask3() {
  testWidgets('module3', (WidgetTester tester) async {
    ...
    final gestureDetectorFinder = findTypeByTextOnlyInParentType(
        GestureDetector, "Statistics".toUpperCase(), Column);
    expect(
      gestureDetectorFinder,
      findsOneWidget,
      reason:
          "There  should be a GestureDetector with text 'STATISTICS' in Column",
    );

    final GestureDetector gestureDetector =
        tester.widget(gestureDetectorFinder);
    expect(
    ...
    expect(
      ...
      findsOneWidget,
      reason:
          "StatisticsPage should be opened after tap on 'STATISTICS' button",
    );

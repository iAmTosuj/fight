...
void runTestLecture4hometask4() {
  testWidgets('module4', (WidgetTester tester) async {
    ...
    expect(
      ...
      findsOneWidget,
      reason:
          "There are should be a SecondaryActionButton with text 'Statistics' in Column",
    );
    ...
    final columnFinder =
        findTypeByTextOnlyInParentType(Column, "Statistics", StatisticsPage);
    ...
    expect(lastWidgetInColumn.child, isNotNull,
        reason: "Padding should have not null child");
    ...
    final SecondaryActionButton secondaryActionButton =
        paddingChild as SecondaryActionButton;
    expect(
